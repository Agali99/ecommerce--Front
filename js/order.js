...
function getOrderItem(product){
    ...
    <div class="row d-flex justify-content-between align-items-center">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2">
            <h6 class="text-muted">Məhsul adı</h6>
            <h6 class="text-black mb-0">`+product['productName']+`</h6>
        </div>
        <div class="col-md-1 col-lg-1 col-xl-1">
            <h6 class="text-muted">Miqdar</h6>
            <h6 class="text-black mb-0">$ `+ product['cost'] + ` x ` + product['orderAmount'] +`</h6>
        </div>
        <div class="col-md-1 col-lg-1 col-xl-1">
            <h6 class="text-muted">Sifariş tarixi</h6>
            <h6 class="text-black mb-0">`+ product['orderDate'][2] + `-` + product['orderDate'][1] + `-` + product['orderDate'][0] + `</h6>
        </div>
        <div class="col-md-2 col-lg-2 col-xl-2">
            <h6 class="text-muted">Mağaza adı</h6>
            <h6 class="text-black mb-0">`+ product['storeName'] +`</h6>
        </div>
        <div class="cocol-md-2 col-lg-2 col-xl-2">
            <h6 class="text-muted">İzləmə kodu</h6>
            <h6 class="text-black mb-0">`+ product['trackNumber'] +`</h6>
        </div>
    </div>
    `
    + 
